    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                <form name="grava" class="text-center" method="POST" action="assets/function/gravar.php">
                    <div class="jumbotron mt-3">
                        <h1>Cadastro de Cliente</h1>
                    </div>
                    <input class="form-control mt-1 cad_info" type="text" name="nome" placeholder="Nome" checked/>
                    <input class="form-control mt-1 cad_info" type="text" name="sobre" placeholder="Sobrenome" checked/>
                    <input class="form-control mt-1 cad_info" type="email" name="email" placeholder="E-mail" checked/>
                    <input class="form-control mt-1 cad_info" type="number" name="cell" placeholder="Celular" checked/>
